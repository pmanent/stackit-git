...
var UI = struct {
	...
	DefaultTheme:            `stackit-dark`,
	Themes:                  []string{`stackit-light`, `stackit-dark`, `forgejo-light`, `forgejo-dark`, `gitea-auto`, `gitea-light`, `gitea-dark`, `forgejo-auto-deuteranopia-protanopia`, `forgejo-light-deuteranopia-protanopia`, `forgejo-dark-deuteranopia-protanopia`, `forgejo-auto-tritanopia`, `forgejo-light-tritanopia`, `forgejo-dark-tritanopia`},
	...
	Meta: struct {
		...
		Author:      "STACKIT Git",
		Description: "STACKIT Git is a self-hosted lightweight software forge. Easy to install and low maintenance, it just does the job.",
		Keywords:    "git,stackit",
	},
}
