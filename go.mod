...
// >>> @@@ STACKIT CODE @@@
// This replacement addresses access issues to the .ht domain when executing the pipeline in the Azure DevOps environment.
// "git.sr.ht/~mariusor/go-xsd-duration@v0.0.0-20220703122237-02e73435a078: unrecognized import path "git.sr.ht/~mariusor/go-xsd-duration": reading https://git.sr.ht/~mariusor/go-xsd-duration?go-get=1: 403 Forbidden"
// I've retrieved the forbidden module from Haiti and added it to our local repository (the code has been inactive for the last two years).
//I've also updated the reference in go.mod to point to this module."

replace git.sr.ht/~mariusor/go-xsd-duration v0.0.0-20220703122237-02e73435a078 => ./packages/go-xsd-duration
