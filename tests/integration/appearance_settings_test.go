...
func TestThemeChange(t *testing.T) {
	...
	// >>> @@@ STACKIT CODE @@@
	// STACKIT ships only the stackit-light/stackit-dark themes (see modules/setting/ui.go),
	// and neither has a themes.names.* translation, so the raw theme name is displayed.

	// Verify default theme
	testSelectedTheme(t, user, "stackit-dark", "stackit-dark", "")

	// Change theme to stackit-light and verify it works fine
	testChangeTheme(t, user, "stackit-light")
	testSelectedTheme(t, user, "stackit-light", "stackit-light", "")
	...
	testSelectedTheme(t, user, "stackit-light", "stackit-light", locale.TrString("settings.theme_update_error"))
	// <<< @@@ STACKIT CODE @@@
}
...
func TestUserHasNonExistentTheme(t *testing.T) {
	...
	// >>> @@@ STACKIT CODE @@@ (STACKIT default theme is stackit-dark)
	testSelectedTheme(t, user, "stackit-dark", "stackit-dark", "")
	// <<< @@@ STACKIT CODE @@@
}
