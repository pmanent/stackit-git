...
LABEL maintainer="git@stackit.cloud" \
  ...
  org.opencontainers.image.url="https://stackit.cloud" \
  org.opencontainers.image.documentation="https://docs.stackit.cloud/stackit/en/git-261161358.html" \
  org.opencontainers.image.source="https://dev.azure.com/schwarzit-wiking/schwarzit.stackit-dev-exp/_git/stackit-git-forgejo" \
  org.opencontainers.image.version="${RELEASE_VERSION}" \
  org.opencontainers.image.vendor="Stackit" \
  org.opencontainers.image.licenses="MIT" \
  org.opencontainers.image.title="Stackit Git." \
  org.opencontainers.image.description="Stackit Git is a self-hosted lightweight software."
