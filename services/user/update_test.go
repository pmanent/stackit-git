...
func TestUpdateUser(t *testing.T) {
	...
	opts := &UpdateOptions{
		...
		// >>> @@@ STACKIT CODE @@@
		// User.AfterLoad resets a theme that is not in setting.UI.Themes to the
		// default, and STACKIT ships only stackit-light/stackit-dark.
		Theme: optional.Some("stackit-dark"),
		// <<< @@@ STACKIT CODE @@@
