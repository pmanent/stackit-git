...
func SubmitInstall(ctx *context.Context) {
	...
	cfg.Section("i18n").Key("LANGS").SetValue("en-US")
	cfg.Section("i18n").Key("NAMES").SetValue("English")
	...
	cfg.Section("stackitgitsettings").Key("LIMIT_OBJECT_STORAGE_SPACE").SetValue(setting.StackitGit.LimitObjectStorageSpace)
	// <<< @@@ STACKIT CODE @@@
