...
const customCSS = {};
const customCSSList = [];
for (const path of glob('custom/public/assets/css/*.css')) {
...
if (isProduction) {
  licenseChecker({
    start: baseDirectory,
    production: true,
    onlyAllow: 'Apache-2.0; 0BSD; BSD-2-Clause; BSD-3-Clause; BlueOak-1.0.0; MIT; ISC; Unlicense; CC-BY-3.0; CC-BY-4.0; CC0-1.0',
